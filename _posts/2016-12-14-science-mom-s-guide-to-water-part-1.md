...
{% include image.html url="/images/SMG1/SMG1a.png" description="Cartoon depiction of water as a solid, liquid, and a gas." maxwidth="600px" %}
...
{% include image.html url="/images/SMG1/SMG1b.png" description="View of Pacific Ocean." maxwidth="800px" %}
...
And join us next time for [Science Mom’s Guide to Water, Part 2](https://science.mom/science-mom-s-guide-to-water-part-2), where we investigate **surface tension**.
