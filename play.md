...
<div class="container">
<img id="zoom_01" src='images/periodictableofpatronssmall.png' data-zoom-image="images/periodictableofpatronslarge.png" alt="Periodic Table of Patrons" style="width:20%;"/>
</div>
<script>
    $('#zoom_01').elevateZoom();
</script>
